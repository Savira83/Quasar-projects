<template>
  <div class="fix">
    ...
    <q-card class="q-pa-none fixed-center bg-grey-1 rounded" style="max-width: 400px; height: 420px; width: 280px">
      <q-form @submit="logIn" @reset="onReset" class="qolumn q-pa-md shadow-2 auth-form row item-center justify-center">
        ...
        ify-center">
          <q-btn label="Sign in" type="submit" color="primary" style="width: 150px" />
        </div>
      </q-form>
    </q-card>
  </div>
